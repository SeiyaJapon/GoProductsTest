...
-- Insert variants for each product_variants using product_variants code to look up product_id

-- product_variants 1: 3 variants
...
-- product_variants 6: 2 variants
INSERT INTO product_variants (product_id, name, sku, price) VALUES
((SELECT id FROM products WHERE code = 'PROD006'), 'Variant A', 'SKU006A', 5.75),
((SELECT id FROM products WHERE code = 'PROD006'), 'Variant B', 'SKU006B', 5.99);

-- product_variants 7: 5 variants
INSERT INTO product_variants (product_id, name, sku, price) VALUES
